...
public class CertificateCombinedExceptionViewAdapter implements SslUntrustedCertDialog.ErrorViewAdapter {
    ...
    public void updateErrorView(View dialogView) {
        ...
        if (mSslException.getCertPathValidatorException() != null) {
            ((TextView)dialogView.findViewById(R.id.reason_cert_not_trusted)).setVisibility(View.GONE);
        } else {
        ...
        if (mSslException.getCertificateExpiredException() != null) {
            ((TextView)dialogView.findViewById(R.id.reason_cert_expired)).setVisibility(View.GONE);
        } else {
        ...
        if (mSslException.getCertificateNotYetValidException() != null) {
            ((TextView)dialogView.findViewById(R.id.reason_cert_not_yet_valid)).setVisibility(View.GONE);
        } else {
        ...
        if (mSslException.getSslPeerUnverifiedException() != null) {
            ((TextView)dialogView.findViewById(R.id.reason_hostname_not_verified)).setVisibility(View.GONE);
        } else {

...
public class HtmlConverter {
    ...
    private static class HtmlToTextTagHandler implements Html.TagHandler {
        ...
        private static final String IGNORED_ANNOTATION_KEY = "Elenoon_ANNOTATION";
        ...
        /**
         * Fetch the matching opening Annotation object and verify that it's the one added by Elenoon.
     ...
     * {@link com.saysys.android.elenoon.view#MessageWebView.setText(String) MessageWebView.setText()}
     * </p>
     *
     * @param text
     *         Plain text string.
    ...
    private static String simpleTextToHtml(String text) {
        ...
        try {
            ...
            //Should never happen
            /*Log.e(Elenoon.LOG_TAG, "Could not read string to convert text to HTML:", e);*/
        }
...
/*            Log.e(Elenoon.LOG_TAG, "Could not read string to convert text to HTML:", e);*/
    ...
    private static final String ElenoonMAIL_CSS_CLASS = "elenoonmail";
    ...
    private static String htmlifyMessageHeader() {
        return "<pre class=\"" + ElenoonMAIL_CSS_CLASS + "\">";
    }
    ...
    /*public static String cssStylePre() {
        final String font = Elenoon.messageViewFixedWidthFont()
                ? "monospace"
                : "sans-serif";
        return "<style type=\"text/css\"> pre." + ElenoonMAIL_CSS_CLASS +

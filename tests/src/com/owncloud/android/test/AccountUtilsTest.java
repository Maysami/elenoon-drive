...
public class AccountUtilsTest extends AndroidTestCase {
    ...
    public void testGetWebdavPathAndOCVersion() {
        OwnCloudVersion ocv12 = new OwnCloudVersion("1.2.0");
        OwnCloudVersion ocv12s = new OwnCloudVersion("1.2");
        OwnCloudVersion ocv22 = new OwnCloudVersion("2.2");
        OwnCloudVersion ocv30 = new OwnCloudVersion("3.0");
        OwnCloudVersion ocv33s = new OwnCloudVersion("3.3.3");
        OwnCloudVersion ocv45 = new OwnCloudVersion("4.5");
        OwnCloudVersion ocv70 = new OwnCloudVersion("7.0");
